...
// when we are working outside of remix, we have to install these imports, because foundry doesn't do this for us

import {PriceConvertor} from "./PriceConvertor.sol";

error FundMe__NotOwnerError(); // see the use in onlyOwner modifier

// this error naming will help you to identify the place of the error and its better to name it like this, contractName__errorName
...
contract FundMe {
    ...
    */
    ...
    modifier onlyOwner() {
        ...
        // if(msg.sender != owner) { revert FundMe__NotOwnerError();}
